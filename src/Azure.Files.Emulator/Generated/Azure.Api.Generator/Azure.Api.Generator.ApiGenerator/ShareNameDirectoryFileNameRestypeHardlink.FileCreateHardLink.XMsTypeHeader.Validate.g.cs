...
public readonly partial struct XMsTypeHeader
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("XMsTypeHeader.json");
        }
    ...
    public static class EnumValues
    {
        ...
        /// as a <see cref = "Azure.Files.Emulator.ShareNameDirectoryFileNameRestypeHardlink.FileCreateHardLink.XMsTypeHeader"/>.
        /// </summary>

...
internal partial class Request
{
    ...
    internal required Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.CompQuery Comp { get; init; }
    internal Corvus.Json.JsonString? Sharesnapshot { get; init; }
    internal Corvus.Json.JsonString? Prevsharesnapshot { get; init; }
    internal Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.TimeoutQuery? Timeout { get; init; }
    internal required Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.XMsVersionHeader XMsVersion { get; init; }

...
internal partial class Request
{
    ...
    internal ShareNameDirectoryFileName.FileDelete.TimeoutQuery? Timeout { get; init; }
    internal required ShareNameDirectoryFileName.FileDelete.XMsVersionHeader XMsVersion { get; init; }
    ...
    internal ShareNameDirectoryFileName.FileDelete.XMsFileRequestIntentHeader? XMsFileRequestIntent { get; init; }
...
""").AsOptional(),
            Timeout = OpenApiGenerator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileDelete.TimeoutQuery>(request, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = OpenApiGenerator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileDelete.XMsVersionHeader>(request, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFileRequestIntent = OpenApiGenerator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileDelete.XMsFileRequestIntentHeader>(request, """
{
  "in": "header",

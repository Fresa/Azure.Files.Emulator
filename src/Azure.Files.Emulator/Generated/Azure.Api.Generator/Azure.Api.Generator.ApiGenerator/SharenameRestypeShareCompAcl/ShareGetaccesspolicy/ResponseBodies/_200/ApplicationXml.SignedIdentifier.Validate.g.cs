                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    if (property.NameEquals(JsonPropertyNames.AccessPolicyUtf8, JsonPropertyNames.AccessPolicy))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.ResponseBodies._200.ApplicationXml.SignedIdentifier.AnAccessPolicy>().Validate(result.CreateChildContext(), level);

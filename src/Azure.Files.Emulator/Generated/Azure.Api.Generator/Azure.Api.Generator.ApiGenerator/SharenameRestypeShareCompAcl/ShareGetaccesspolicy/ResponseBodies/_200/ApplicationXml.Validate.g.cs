...
public readonly partial struct ApplicationXml
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.ResponseBodies.200.ApplicationXml.json");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level)
        {
            ...
            int length = 0;
            using JsonArrayEnumerator<ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.ResponseBodies._200.ApplicationXml.SignedIdentifier> arrayEnumerator = value.EnumerateArray();

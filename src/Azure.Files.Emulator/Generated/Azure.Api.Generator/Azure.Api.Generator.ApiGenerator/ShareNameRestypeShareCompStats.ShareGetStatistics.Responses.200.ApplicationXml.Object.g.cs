...
/// </para>
/// </remarks>
public readonly partial struct ApplicationXml : IJsonObject<Azure.Files.Emulator.ShareNameRestypeShareCompStats.ShareGetStatistics.Responses._200.ApplicationXml>
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the <c>ShareUsageBytes</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Json.JsonInteger ShareUsageBytes
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                if (this.jsonElementBacking.TryGetProperty(JsonPropertyNames.ShareUsageBytesUtf8, out JsonElement result))
                {
                    return new(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.ShareUsageBytes, out JsonAny result))
                {
    ...
    /// </summary>
    public static ApplicationXml Create(in Corvus.Json.JsonInteger shareUsageBytes)
    {
        var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
        builder.Add(JsonPropertyNames.ShareUsageBytes, shareUsageBytes.AsAny);
    ...
    /// <summary>
    /// Sets the <c>ShareUsageBytes</c> property.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public ApplicationXml WithShareUsageBytes(in Corvus.Json.JsonInteger value)
    {
        return this.SetProperty(JsonPropertyNames.ShareUsageBytes, value);
    }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref = "ShareUsageBytes"/>.
        /// </summary>
        public const string ShareUsageBytes = "ShareUsageBytes";
        /// <summary>
        /// Gets the JSON property name for <see cref = "ShareUsageBytes"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ShareUsageBytesUtf8 => "ShareUsageBytes"u8;
    }

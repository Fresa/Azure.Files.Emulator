...
#if NET8_0_OR_GREATER
    : IJsonNumber<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery>,
      IAdditionOperators<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery, Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery, Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery>,
      ISubtractionOperators<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery, Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery, Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery>,
      IMultiplyOperators<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery, Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery, Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery>,
      IDivisionOperators<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery, Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery, Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery>,
      IIncrementOperators<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery>,
      IDecrementOperators<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery>
#else
: IJsonNumber<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.MaxresultsQuery>
#endif
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "MaxresultsQuery"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public MaxresultsQuery(long value) : this(new BinaryJsonNumber(value))
    {
    }
    ...
    public static implicit operator MaxresultsQuery(JsonNumber value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator JsonNumber(MaxresultsQuery value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator JsonInteger(MaxresultsQuery value)
    {
    ...
    public static explicit operator byte (MaxresultsQuery value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref = "MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(byte value)
    {
    ...
    public static explicit operator decimal (MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name = "value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref = "MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(decimal value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator double (MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name = "value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref = "MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(double value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator short (MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name = "value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref = "MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(short value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator int (MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name = "value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref = "MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(int value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static implicit operator long (MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name = "value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref = "MaxresultsQuery"/>.</returns>
    public static implicit operator MaxresultsQuery(long value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator Int128(MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    public static explicit operator sbyte (MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name = "value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref = "MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(sbyte value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator Half(MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    public static explicit operator float (MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name = "value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref = "MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(float value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator ushort (MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name = "value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref = "MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(ushort value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator uint (MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name = "value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref = "MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(uint value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator ulong (MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name = "value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref = "MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(ulong value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator UInt128(MaxresultsQuery value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MaxresultsQuery"/>.</returns>
    public static explicit operator MaxresultsQuery(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    /// </returns>
    public static bool operator <(MaxresultsQuery left, MaxresultsQuery right)
    {
    ...
    public static MaxresultsQuery operator +(MaxresultsQuery left, MaxresultsQuery right)
    {
    ...
    /// <returns>The result of the operation.</returns>
    public static MaxresultsQuery operator ++(MaxresultsQuery value)
    {
    ...
    /// </returns>
    public static int Compare(in MaxresultsQuery lhs, in MaxresultsQuery rhs)
    {

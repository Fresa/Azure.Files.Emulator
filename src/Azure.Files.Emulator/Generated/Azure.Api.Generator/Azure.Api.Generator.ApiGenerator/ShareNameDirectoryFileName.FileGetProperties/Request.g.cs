...
""").AsOptional(),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileGetProperties.TimeoutQuery>(request, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileGetProperties.XMsVersionHeader>(request, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileGetProperties.XMsFileRequestIntentHeader>(request, """
{
  "in": "header",
...
"""),
            XMsType = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileCreate.XMsTypeHeader>(request, """
{
  "in": "header",
  "name": "x-ms-type",
...
""").AsOptional(),
            XMsFilePermissionFormat = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileCreate.XMsFilePermissionFormatHeader>(request, """
{
  "in": "header",
...
""").AsOptional(),
            XMsFileFileType = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileCreate.XMsFileFileTypeHeader>(request, """
{
  "in": "header",

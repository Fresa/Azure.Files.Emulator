...
internal partial class Request
{
    ...
    internal ShareNameDirectoryFileName.FileGetProperties.TimeoutQuery? Timeout { get; init; }
    internal required ShareNameDirectoryFileName.FileGetProperties.XMsVersionHeader XMsVersion { get; init; }
    ...
    internal ShareNameDirectoryFileName.FileGetProperties.XMsFileRequestIntentHeader? XMsFileRequestIntent { get; init; }
...
""").AsOptional(),
            Timeout = OpenApiGenerator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileGetProperties.TimeoutQuery>(request, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = OpenApiGenerator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileGetProperties.XMsVersionHeader>(request, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsRangeGetContentMd5 = OpenApiGenerator.HttpRequestExtensions.Bind<Corvus.Json.JsonBoolean>(request, """
{
  "in": "header",
...
""").AsOptional(),
            XMsFileRequestIntent = OpenApiGenerator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileGetProperties.XMsFileRequestIntentHeader>(request, """
{
  "in": "header",
...
"""),
            XMsType = OpenApiGenerator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileCreate.XMsTypeHeader>(request, """
{
  "in": "header",
  "name": "x-ms-type",
...
""").AsOptional(),
            XMsFilePermissionFormat = OpenApiGenerator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileCreate.XMsFilePermissionFormatHeader>(request, """
{
  "in": "header",
...
""").AsOptional(),
            XMsFileFileType = OpenApiGenerator.HttpRequestExtensions.Bind<ShareNameDirectoryFileName.FileCreate.XMsFileFileTypeHeader>(request, """
{
  "in": "header",

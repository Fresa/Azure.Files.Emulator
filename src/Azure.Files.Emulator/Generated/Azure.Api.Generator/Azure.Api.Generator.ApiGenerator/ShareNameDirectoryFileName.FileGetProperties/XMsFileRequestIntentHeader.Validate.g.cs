...
public readonly partial struct XMsFileRequestIntentHeader
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("ShareNameDirectoryFileName.FileGetProperties.XMsFileRequestIntentHeader.json");
        }
    ...
    public static class EnumValues
    {
        ...
        /// as a <see cref = "ShareNameDirectoryFileName.FileGetProperties.XMsFileRequestIntentHeader"/>.
        /// </summary>

                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        foreach (JsonObjectProperty property in value.EnumerateObject())
                        {
                            ...
                            else if (property.NameEquals(JsonPropertyNames.NameUtf8, JsonPropertyNames.Name))
                            {
                                ...
                                ValidationContext propertyResult = property.Value.As<ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.ResponseBodies._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.NameEntity>().Validate(result.CreateChildContext(), level);
                                if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                                {
                                    return propertyResult;
                                }
                            ...
                            else if (property.NameEquals(JsonPropertyNames.PropertiesUtf8, JsonPropertyNames.Properties))
                            {
                                ...
                                ValidationContext propertyResult = property.Value.As<ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.ResponseBodies._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.FileProperties>().Validate(result.CreateChildContext(), level);
                                if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                                {
                                    return propertyResult;
                                }

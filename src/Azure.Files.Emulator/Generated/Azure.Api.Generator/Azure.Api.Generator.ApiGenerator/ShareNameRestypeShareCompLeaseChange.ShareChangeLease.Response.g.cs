...
internal abstract partial class Response
{
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameRestypeShareCompLeaseChange.ShareChangeLease.Content._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

        internal Azure.Files.Emulator.ShareNameRestypeShareCompLeaseChange.ShareChangeLease.Content._Default.ApplicationXml? ApplicationXml { get; set; }

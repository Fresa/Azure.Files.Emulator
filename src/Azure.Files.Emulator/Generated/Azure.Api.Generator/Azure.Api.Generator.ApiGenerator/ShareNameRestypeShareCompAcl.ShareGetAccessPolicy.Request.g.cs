...
internal partial class Request
{
    ...
    internal Azure.Files.Emulator.ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.TimeoutQuery? Timeout { get; init; }
    internal required Azure.Files.Emulator.ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.XMsVersionHeader XMsVersion { get; init; }
    internal Corvus.Json.JsonString? XMsLeaseId { get; init; }
    internal Azure.Files.Emulator.ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.XMsFileRequestIntentHeader? XMsFileRequestIntent { get; init; }
...
"""),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.TimeoutQuery>(httpRequest, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.XMsVersionHeader>(httpRequest, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.XMsFileRequestIntentHeader>(httpRequest, """
{
  "in": "header",

...
internal abstract partial class Response
{
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseRelease.FileReleaseLease.Responses._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

        internal Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseRelease.FileReleaseLease.Responses._Default.ApplicationXml? ApplicationXml { get; set; }

...
internal partial class Request
{
    ...
    internal required Azure.Files.Emulator.ShareNameDirectoryCompForceclosehandles.CompQuery Comp { get; init; }
    internal Azure.Files.Emulator.ShareNameDirectoryCompForceclosehandles.DirectoryForceCloseHandles.TimeoutQuery? Timeout { get; init; }
    ...
    internal required Azure.Files.Emulator.ShareNameDirectoryCompForceclosehandles.DirectoryForceCloseHandles.XMsVersionHeader XMsVersion { get; init; }
    internal Corvus.Json.JsonBoolean? XMsAllowTrailingDot { get; init; }
    internal Azure.Files.Emulator.ShareNameDirectoryCompForceclosehandles.DirectoryForceCloseHandles.XMsFileRequestIntentHeader? XMsFileRequestIntent { get; init; }
...
"""),
            Comp = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryCompForceclosehandles.CompQuery>(httpRequest, """
{
  "in": "query",
  "name": "comp",
  "description": "comp",
...
"""),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryCompForceclosehandles.DirectoryForceCloseHandles.TimeoutQuery>(httpRequest, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsHandleId = Azure.Files.Emulator.HttpRequestExtensions.Bind<Corvus.Json.JsonString>(httpRequest, """
{
  "in": "header",
  "name": "x-ms-handle-id",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryCompForceclosehandles.DirectoryForceCloseHandles.XMsVersionHeader>(httpRequest, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryCompForceclosehandles.DirectoryForceCloseHandles.XMsFileRequestIntentHeader>(httpRequest, """
{
  "in": "header",

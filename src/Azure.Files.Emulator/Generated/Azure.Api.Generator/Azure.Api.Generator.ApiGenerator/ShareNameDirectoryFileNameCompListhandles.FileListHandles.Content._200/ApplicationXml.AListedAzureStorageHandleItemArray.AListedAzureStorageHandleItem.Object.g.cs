...
public readonly partial struct ApplicationXml
{
    ...
    public readonly partial struct AListedAzureStorageHandleItemArray
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct AListedAzureStorageHandleItem : IJsonObject<ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem>
        {
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.AccessRightsOfTheAccessPolicyArray? AccessRightList
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        if (this.objectBacking.TryGetValue(JsonPropertyNames.AccessRightList, out JsonAny result))
                        {
                            ...
                            return result.As<ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.AccessRightsOfTheAccessPolicyArray>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.PathEntity Path
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.PathEntity>();
                        }
                    }
            ...
            /// </summary>
            public static AListedAzureStorageHandleItem Create(in Corvus.Json.JsonString clientIp, in Corvus.Json.JsonString clientName, in Corvus.Json.JsonString fileId, in Corvus.Json.JsonString handleId, in Corvus.Json.JsonString openTime, in ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.PathEntity path, in Corvus.Json.JsonString sessionId, in ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.AccessRightsOfTheAccessPolicyArray? accessRightList = null, in Corvus.Json.JsonString? lastReconnectTime = null, in Corvus.Json.JsonString? parentId = null)
            {
            ...
            public AListedAzureStorageHandleItem WithAccessRightList(in ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.AccessRightsOfTheAccessPolicyArray? value)
            {
            ...
            /// <param name = "value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public AListedAzureStorageHandleItem WithPath(in ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.PathEntity value)
            {

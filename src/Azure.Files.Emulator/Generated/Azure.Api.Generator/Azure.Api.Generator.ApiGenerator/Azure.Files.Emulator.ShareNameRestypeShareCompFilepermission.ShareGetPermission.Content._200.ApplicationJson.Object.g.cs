...
namespace Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Content._200;
/// <summary>
...
/// </para>
/// </remarks>
public readonly partial struct ApplicationJson : IJsonObject<Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Content._200.ApplicationJson>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Content._200.ApplicationJson.FormatEntity? Format
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.Format, out JsonAny result))
                {
                    ...
                    return result.As<Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Content._200.ApplicationJson.FormatEntity>();
                }
            }
    ...
    /// </summary>
    public static ApplicationJson Create(in Corvus.Json.JsonString permission, in Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Content._200.ApplicationJson.FormatEntity? format = null)
    {
    ...
    public ApplicationJson WithFormat(in Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Content._200.ApplicationJson.FormatEntity? value)
    {

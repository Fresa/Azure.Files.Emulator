...
/// </para>
/// </remarks>
public readonly partial struct ApplicationXml : IJsonObject<Azure.Files.Emulator.CompList.ServiceListSharesSegment.Responses._200.ApplicationXml>
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the (optional) <c>ShareItems</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// If this JSON property is <see cref = "JsonValueKind.Undefined"/> then the value returned will be <see langword="null"/>.
    /// </para>
    /// </remarks>
    public Azure.Files.Emulator.CompList.ServiceListSharesSegment.Responses._200.ApplicationXml.AListedAzureStorageShareItemArray? ShareItems
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                if (this.jsonElementBacking.TryGetProperty(JsonPropertyNames.ShareItemsUtf8, out JsonElement result))
                {
                    if (result.ValueKind == JsonValueKind.Null || result.ValueKind == JsonValueKind.Undefined)
                    {
                        return default;
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.ShareItems, out JsonAny result))
                {
                    if (result.IsNullOrUndefined())
                    {
                        return default;
                    ...
                    return result.As<Azure.Files.Emulator.CompList.ServiceListSharesSegment.Responses._200.ApplicationXml.AListedAzureStorageShareItemArray>();
                }
            }
    ...
    /// </summary>
    public static ApplicationXml Create(in Corvus.Json.JsonString nextMarker, in Corvus.Json.JsonString serviceEndpoint, in Corvus.Json.JsonString? marker = null, in Corvus.Json.JsonInteger? maxResults = null, in Corvus.Json.JsonString? prefix = null, in Azure.Files.Emulator.CompList.ServiceListSharesSegment.Responses._200.ApplicationXml.AListedAzureStorageShareItemArray? shareItems = null)
    {
        ...
        if (shareItems is not null)
        {
            builder.Add(JsonPropertyNames.ShareItems, shareItems.Value.AsAny);
        }
    ...
    /// <param name = "value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public ApplicationXml WithPrefix(in Corvus.Json.JsonString? value)
    {
        return value.HasValue ? this.SetProperty(JsonPropertyNames.Prefix, value.Value) : this.RemoveProperty(JsonPropertyNames.Prefix);
    }
    ...
    /// <summary>
    /// Sets the (optional) <c>ShareItems</c> property.
    /// </summary>
    /// <param name = "value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public ApplicationXml WithShareItems(in Azure.Files.Emulator.CompList.ServiceListSharesSegment.Responses._200.ApplicationXml.AListedAzureStorageShareItemArray? value)
    {
        return value.HasValue ? this.SetProperty(JsonPropertyNames.ShareItems, value.Value) : this.RemoveProperty(JsonPropertyNames.ShareItems);
    }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref = "ShareItems"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref = "ShareItems"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ShareItemsUtf8 => "ShareItems"u8;
    }

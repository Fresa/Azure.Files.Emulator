...
internal partial class Request
{
    ...
    internal required Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseChange.CompQuery Comp { get; init; }
    internal required Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseChange.XMsLeaseActionHeader XMsLeaseAction { get; init; }
    internal Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseChange.FileChangeLease.TimeoutQuery? Timeout { get; init; }
    internal required Corvus.Json.JsonString XMsLeaseId { get; init; }
    internal Corvus.Json.JsonString? XMsProposedLeaseId { get; init; }
    internal required Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseChange.FileChangeLease.XMsVersionHeader XMsVersion { get; init; }
    internal Corvus.Json.JsonString? XMsClientRequestId { get; init; }
    internal Corvus.Json.JsonBoolean? XMsAllowTrailingDot { get; init; }
    internal Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseChange.FileChangeLease.XMsFileRequestIntentHeader? XMsFileRequestIntent { get; init; }
...
"""),
            Comp = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseChange.CompQuery>(httpRequest, """
{
  "in": "query",
  "name": "comp",
  "description": "comp",
...
"""),
            XMsLeaseAction = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseChange.XMsLeaseActionHeader>(httpRequest, """
{
  "in": "header",
...
"""),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseChange.FileChangeLease.TimeoutQuery>(httpRequest, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseChange.FileChangeLease.XMsVersionHeader>(httpRequest, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseChange.FileChangeLease.XMsFileRequestIntentHeader>(httpRequest, """
{
  "in": "header",

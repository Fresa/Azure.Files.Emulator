                ...
                internal static ValidationContext ObjectValidationHandler(in TheRetentionPolicy value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty property in value.EnumerateObject())
                    {
                        if (property.NameEquals(JsonPropertyNames.DaysUtf8, JsonPropertyNames.Days))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<Azure.Files.Emulator.RestypeServiceCompProperties.ServiceSetProperties.Requests.ApplicationXml.ApplicationXmlStorageAnalyticsMetricsForFileService.TheRetentionPolicy.DaysEntity>().Validate(result.CreateChildContext(), level);

...
"""),
            Restype = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompRename.RestypeQuery>(request, """
{
  "in": "query",
  "name": "restype",
  "description": "restype",
...
"""),
            Comp = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompRename.CompQuery>(request, """
{
  "in": "query",
  "name": "comp",
  "description": "comp",
...
"""),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompRename.DirectoryRename.TimeoutQuery>(request, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompRename.DirectoryRename.XMsVersionHeader>(request, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFilePermissionFormat = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompRename.DirectoryRename.XMsFilePermissionFormatHeader>(request, """
{
  "in": "header",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompRename.DirectoryRename.XMsFileRequestIntentHeader>(request, """
{
  "in": "header",

...
/// </para>
/// </remarks>
public readonly partial struct ApplicationXml : IJsonObject<Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareCreatePermission.Requests.ApplicationXml>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareCreatePermission.Requests.ApplicationXml.FormatEntity? Format
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.Format, out JsonAny result))
                {
                    ...
                    return result.As<Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareCreatePermission.Requests.ApplicationXml.FormatEntity>();
                }
            }
    ...
    /// </summary>
    public static ApplicationXml Create(in Corvus.Json.JsonString permission, in Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareCreatePermission.Requests.ApplicationXml.FormatEntity? format = null)
    {
    ...
    public ApplicationXml WithFormat(in Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareCreatePermission.Requests.ApplicationXml.FormatEntity? value)
    {

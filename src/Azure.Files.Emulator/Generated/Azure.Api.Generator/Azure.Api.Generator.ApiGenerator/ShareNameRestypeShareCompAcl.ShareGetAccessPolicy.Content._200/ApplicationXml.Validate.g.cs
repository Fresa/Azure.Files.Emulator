...
public readonly partial struct ApplicationXml
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.Content.200.ApplicationXml.json");
        }
    ...
    public static partial class CorvusValidation
    {
        ...
        internal static ValidationContext ArrayValidationHandler(in ApplicationXml value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            int length = 0;
            using JsonArrayEnumerator<ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.Content._200.ApplicationXml.SignedIdentifier> arrayEnumerator = value.EnumerateArray();

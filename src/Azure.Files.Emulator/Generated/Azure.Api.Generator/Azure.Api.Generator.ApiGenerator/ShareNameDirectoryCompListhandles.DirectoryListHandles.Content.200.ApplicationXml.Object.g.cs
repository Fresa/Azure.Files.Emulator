...
/// </para>
/// </remarks>
public readonly partial struct ApplicationXml : IJsonObject<Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Content._200.ApplicationXml>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray? HandleList
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.HandleList, out JsonAny result))
                {
                    ...
                    return result.As<Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray>();
                }
            }
    ...
    /// </summary>
    public static ApplicationXml Create(in Corvus.Json.JsonString nextMarker, in Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray? handleList = null)
    {
    ...
    public ApplicationXml WithHandleList(in Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray? value)
    {

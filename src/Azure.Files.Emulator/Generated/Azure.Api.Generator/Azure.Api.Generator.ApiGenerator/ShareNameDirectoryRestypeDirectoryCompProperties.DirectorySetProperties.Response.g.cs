...
internal abstract partial class Response
{
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompProperties.DirectorySetProperties.Content._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

        internal Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompProperties.DirectorySetProperties.Content._Default.ApplicationXml? ApplicationXml { get; set; }

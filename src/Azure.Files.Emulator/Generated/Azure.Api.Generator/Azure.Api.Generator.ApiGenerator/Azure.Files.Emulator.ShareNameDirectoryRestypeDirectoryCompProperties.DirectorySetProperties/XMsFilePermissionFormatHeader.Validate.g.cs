...
public readonly partial struct XMsFilePermissionFormatHeader
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("XMsFilePermissionFormatHeader.json");
        }
    ...
    public static class EnumValues
    {
        ...
        /// as a <see cref = "Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompProperties.DirectorySetProperties.XMsFilePermissionFormatHeader"/>.
        /// </summary>

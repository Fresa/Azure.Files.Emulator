...
internal abstract partial class Response
{
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameRestypeShareCompProperties.ShareSetProperties.Content._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

        internal Azure.Files.Emulator.ShareNameRestypeShareCompProperties.ShareSetProperties.Content._Default.ApplicationXml? ApplicationXml { get; set; }

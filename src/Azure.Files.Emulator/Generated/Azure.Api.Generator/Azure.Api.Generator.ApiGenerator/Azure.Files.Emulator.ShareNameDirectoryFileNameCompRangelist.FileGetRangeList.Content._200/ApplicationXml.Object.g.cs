...
/// </para>
/// </remarks>
public readonly partial struct ApplicationXml : IJsonObject<Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.Content._200.ApplicationXml>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.Content._200.ApplicationXml.RequiredEndAndStartArray? ClearRanges
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.ClearRanges, out JsonAny result))
                {
                    ...
                    return result.As<Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.Content._200.ApplicationXml.RequiredEndAndStartArray>();
                }
            }
    ...
    /// </para>
    /// </remarks>
    public Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.Content._200.ApplicationXml.AnAzureStorageFileRangeArray? Ranges
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.Ranges, out JsonAny result))
                {
                    ...
                    return result.As<Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.Content._200.ApplicationXml.AnAzureStorageFileRangeArray>();
                }
            }
    ...
    /// </summary>
    public static ApplicationXml Create(in Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.Content._200.ApplicationXml.RequiredEndAndStartArray? clearRanges = null, in Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.Content._200.ApplicationXml.AnAzureStorageFileRangeArray? ranges = null)
    {
    ...
    public ApplicationXml WithClearRanges(in Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.Content._200.ApplicationXml.RequiredEndAndStartArray? value)
    {
    ...
    /// <param name = "value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public ApplicationXml WithRanges(in Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.Content._200.ApplicationXml.AnAzureStorageFileRangeArray? value)
    {

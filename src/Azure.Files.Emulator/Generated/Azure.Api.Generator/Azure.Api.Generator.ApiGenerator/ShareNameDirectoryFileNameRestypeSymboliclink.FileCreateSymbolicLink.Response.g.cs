...
internal abstract partial class Response
{
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameDirectoryFileNameRestypeSymboliclink.FileCreateSymbolicLink.Content._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

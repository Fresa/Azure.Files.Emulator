...
public readonly partial struct ApplicationXml
{
    ...
    public readonly partial struct AbstractForEntriesThatCanBeListedFromDirectory
    {
        ...
        public readonly partial struct AListedFileItemArray
        {
            ...
            /// </para>
            /// </remarks>
            public readonly partial struct AListedFileItem : IJsonObject<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Content._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem>
            {
                /// <summary>
                /// Conversion from <see cref = "ImmutableList{JsonObjectProperty}"/>.
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator AListedFileItem(ImmutableList<JsonObjectProperty> value)
                {
                    return new(value);
                }
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator ImmutableList<JsonObjectProperty>(AListedFileItem value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator AListedFileItem(JsonObject value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator JsonObject(AListedFileItem value)
                {
                ...
                /// </para>
                /// </remarks>
                public Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Content._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.NameEntity Name
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        ...
                        if ((this.backing & Backing.Object) != 0)
                        {
                            ...
                            {
                                return result.As<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Content._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.NameEntity>();
                            }
                        }
                ...
                /// </para>
                /// </remarks>
                public Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Content._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.FileProperties Properties
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        ...
                        if ((this.backing & Backing.Object) != 0)
                        {
                            ...
                            {
                                return result.As<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Content._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.FileProperties>();
                            }
                        }
                ...
                /// <inheritdoc/>
                public static AListedFileItem FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                {
                    return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
                }

                /// <inheritdoc/>
                public static AListedFileItem FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                {
                ...
                public static AListedFileItem FromProperties(ImmutableList<JsonObjectProperty> source)
                {
                    return new(source);
                }

                /// <summary>
                /// Creates an instance of a <see cref = "AListedFileItem"/>.
                /// </summary>
                public static AListedFileItem Create(in Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Content._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.NameEntity name, in Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Content._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.FileProperties properties, in Corvus.Json.JsonString? attributes = null, in Corvus.Json.JsonString? fileId = null, in Corvus.Json.JsonString? permissionKey = null)
                {
                ...
                public AListedFileItem WithAttributes(in Corvus.Json.JsonString? value)
                {
                ...
                /// <param name = "value">The new property value</param>
                /// <returns>The instance with the property set.</returns>
                public AListedFileItem WithFileId(in Corvus.Json.JsonString? value)
                {
                ...
                /// <param name = "value">The new property value</param>
                /// <returns>The instance with the property set.</returns>
                public AListedFileItem WithName(in Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Content._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.NameEntity value)
                {
                ...
                /// <param name = "value">The new property value</param>
                /// <returns>The instance with the property set.</returns>
                public AListedFileItem WithPermissionKey(in Corvus.Json.JsonString? value)
                {
                ...
                /// </para>
                /// </remarks>
                public AListedFileItem WithProperties(in Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Content._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.FileProperties value)
                {
                ...
                /// <inheritdoc/>
                public AListedFileItem SetProperty<TValue>(in JsonPropertyName name, TValue value)
                ...
                /// <inheritdoc/>
                public AListedFileItem RemoveProperty(in JsonPropertyName name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc/>
                public AListedFileItem RemoveProperty(string name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc/>
                public AListedFileItem RemoveProperty(ReadOnlySpan<char> name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc/>
                public AListedFileItem RemoveProperty(ReadOnlySpan<byte> name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }
                ...
                private static class __CorvusObjectHelpers
                {
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in AListedFileItem that)
                    {
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AListedFileItem that, in JsonPropertyName name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                    ...
                    /// <returns>An immutable list of <see cref = "JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AListedFileItem that, ReadOnlySpan<char> name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <returns>An immutable list of <see cref = "JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AListedFileItem that, ReadOnlySpan<byte> name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <returns>An immutable list of <see cref = "JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AListedFileItem that, string name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in AListedFileItem that, in JsonPropertyName name, in JsonAny value)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {

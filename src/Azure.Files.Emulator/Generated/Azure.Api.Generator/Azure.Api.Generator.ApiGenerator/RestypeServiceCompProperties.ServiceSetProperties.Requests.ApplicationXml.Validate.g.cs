        ...
        internal static ValidationContext ObjectValidationHandler(in ApplicationXml value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                if (property.NameEquals(JsonPropertyNames.CorsUtf8, JsonPropertyNames.Cors))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Azure.Files.Emulator.RestypeServiceCompProperties.ServiceSetProperties.Requests.ApplicationXml.CorsEntityArray>().Validate(result.CreateChildContext(), level);
                ...
                else if (property.NameEquals(JsonPropertyNames.HourMetricsUtf8, JsonPropertyNames.HourMetrics))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Azure.Files.Emulator.RestypeServiceCompProperties.ServiceSetProperties.Requests.ApplicationXml.StorageAnalyticsMetricsForFileService>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
                ...
                else if (property.NameEquals(JsonPropertyNames.MinuteMetricsUtf8, JsonPropertyNames.MinuteMetrics))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Azure.Files.Emulator.RestypeServiceCompProperties.ServiceSetProperties.Requests.ApplicationXml.ApplicationXmlStorageAnalyticsMetricsForFileService>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
                ...
                else if (property.NameEquals(JsonPropertyNames.ProtocolUtf8, JsonPropertyNames.Protocol))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Azure.Files.Emulator.RestypeServiceCompProperties.ServiceSetProperties.Requests.ApplicationXml.ProtocolSettings>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }

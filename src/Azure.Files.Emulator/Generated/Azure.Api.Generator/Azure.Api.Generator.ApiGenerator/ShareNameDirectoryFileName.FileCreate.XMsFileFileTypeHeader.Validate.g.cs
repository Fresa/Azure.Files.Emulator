...
public readonly partial struct XMsFileFileTypeHeader
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("XMsFileFileTypeHeader.json");
        }
    ...
    public static class EnumValues
    {
        ...
        /// as a <see cref = "Azure.Files.Emulator.ShareNameDirectoryFileName.FileCreate.XMsFileFileTypeHeader"/>.
        /// </summary>
        ...
        /// </summary>
        public static ReadOnlySpan<byte> RegularUtf8 => CorvusValidation.Enum1Utf8;
        /// <summary>
        ...
        /// as a UTF8 byte array.
        /// </summary>
        public static ReadOnlySpan<byte> DirectoryUtf8 => CorvusValidation.Enum2Utf8;
        /// <summary>
        ...
        /// as a UTF8 byte array.
        /// </summary>
        public static ReadOnlySpan<byte> SymLinkUtf8 => CorvusValidation.Enum3Utf8;
    }
    ...
    public static partial class CorvusValidation
    {
        ...
        /// </summary>
        public static readonly JsonString Enum1 = JsonString.ParseValue("\"Regular\"");
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly JsonString Enum2 = JsonString.ParseValue("\"Directory\"");
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly JsonString Enum3 = JsonString.ParseValue("\"SymLink\"");
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static ReadOnlySpan<byte> Enum1Utf8 => "\"Regular\""u8;
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static ReadOnlySpan<byte> Enum2Utf8 => "\"Directory\""u8;
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static ReadOnlySpan<byte> Enum3Utf8 => "\"SymLink\""u8;
        ...
        /// <returns>The resulting validation context after validation.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static ValidationContext CompositionAnyOfValidationHandler(in XMsFileFileTypeHeader value, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ValidationContext result = validationContext;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            static ValidationContext ValidateEnum(in XMsFileFileTypeHeader value, in ValidationContext validationContext, ValidationLevel level)
            {
                ValidationContext result = validationContext;

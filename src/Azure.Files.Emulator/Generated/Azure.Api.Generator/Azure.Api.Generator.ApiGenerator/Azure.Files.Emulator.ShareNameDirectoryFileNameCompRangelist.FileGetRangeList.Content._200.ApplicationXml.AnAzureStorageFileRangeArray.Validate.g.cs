    ...
    public readonly partial struct AnAzureStorageFileRangeArray
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("#/properties/Ranges");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            /// <returns>The resulting validation context after validation.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal static ValidationContext ArrayValidationHandler(in AnAzureStorageFileRangeArray value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
            {
                ValidationContext result = validationContext;
                ...
                int length = 0;
                using JsonArrayEnumerator<Azure.Files.Emulator.ShareNameDirectoryFileNameCompRangelist.FileGetRangeList.Content._200.ApplicationXml.AnAzureStorageFileRangeArray.AnAzureStorageFileRange> arrayEnumerator = value.EnumerateArray();

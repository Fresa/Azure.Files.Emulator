...
internal partial class Request
{
    ...
    internal Azure.Files.Emulator.ShareNameRestypeShare.ShareDelete.TimeoutQuery? Timeout { get; init; }
    internal required Azure.Files.Emulator.ShareNameRestypeShare.ShareDelete.XMsVersionHeader XMsVersion { get; init; }
    internal Corvus.Json.JsonString? XMsLeaseId { get; init; }
    internal Azure.Files.Emulator.ShareNameRestypeShare.ShareDelete.XMsFileRequestIntentHeader? XMsFileRequestIntent { get; init; }
    internal Corvus.Json.JsonString? XMsMeta { get; init; }
    internal Azure.Files.Emulator.ShareNameRestypeShare.ShareCreate.XMsShareQuotaHeader? XMsShareQuota { get; init; }
    internal Azure.Files.Emulator.ShareNameRestypeShare.ShareCreate.XMsAccessTierHeader? XMsAccessTier { get; init; }
    internal Corvus.Json.JsonString? XMsEnabledProtocols { get; init; }
    internal Azure.Files.Emulator.ShareNameRestypeShare.ShareCreate.XMsRootSquashHeader? XMsRootSquash { get; init; }
    ...
    internal Azure.Files.Emulator.ShareNameRestypeShare.ShareDelete.XMsDeleteSnapshotsHeader? XMsDeleteSnapshots { get; init; }
...
""").AsOptional(),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameRestypeShare.ShareDelete.TimeoutQuery>(httpRequest, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameRestypeShare.ShareDelete.XMsVersionHeader>(httpRequest, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameRestypeShare.ShareDelete.XMsFileRequestIntentHeader>(httpRequest, """
{
  "in": "header",
...
""").AsOptional(),
            XMsDeleteSnapshots = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameRestypeShare.ShareDelete.XMsDeleteSnapshotsHeader>(httpRequest, """
{
  "in": "header",

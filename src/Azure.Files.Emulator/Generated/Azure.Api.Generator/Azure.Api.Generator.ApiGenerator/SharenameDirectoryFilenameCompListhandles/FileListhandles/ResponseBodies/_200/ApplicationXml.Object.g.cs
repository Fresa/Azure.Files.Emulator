...
public readonly partial struct ApplicationXml
    : IJsonObject<ShareNameDirectoryFileNameCompListhandles.FileListHandles.ResponseBodies._200.ApplicationXml>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public ShareNameDirectoryFileNameCompListhandles.FileListHandles.ResponseBodies._200.ApplicationXml.AListedAzureStorageHandleItemArray? HandleList
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.HandleList, out JsonAny result))
                {
                    ...
                    return result.As<ShareNameDirectoryFileNameCompListhandles.FileListHandles.ResponseBodies._200.ApplicationXml.AListedAzureStorageHandleItemArray>();
                }
            }
    ...
    /// </summary>
    public static ApplicationXml Create(in Corvus.Json.JsonString nextMarker, in ShareNameDirectoryFileNameCompListhandles.FileListHandles.ResponseBodies._200.ApplicationXml.AListedAzureStorageHandleItemArray? handleList = null)
    {
    ...
    public ApplicationXml WithHandleList(in ShareNameDirectoryFileNameCompListhandles.FileListHandles.ResponseBodies._200.ApplicationXml.AListedAzureStorageHandleItemArray? value)
    {

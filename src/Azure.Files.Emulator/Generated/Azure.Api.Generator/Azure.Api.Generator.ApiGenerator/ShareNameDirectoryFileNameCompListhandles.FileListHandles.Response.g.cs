...
internal abstract partial class Response
{
    ...
    {
        public OK200(Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml applicationXml)
        {
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

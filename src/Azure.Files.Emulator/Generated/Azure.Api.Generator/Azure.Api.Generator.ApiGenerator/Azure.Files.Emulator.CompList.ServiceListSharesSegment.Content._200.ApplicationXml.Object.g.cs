...
/// </para>
/// </remarks>
public readonly partial struct ApplicationXml : IJsonObject<Azure.Files.Emulator.CompList.ServiceListSharesSegment.Content._200.ApplicationXml>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public Azure.Files.Emulator.CompList.ServiceListSharesSegment.Content._200.ApplicationXml.AListedAzureStorageShareItemArray? ShareItems
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.ShareItems, out JsonAny result))
                {
                    ...
                    return result.As<Azure.Files.Emulator.CompList.ServiceListSharesSegment.Content._200.ApplicationXml.AListedAzureStorageShareItemArray>();
                }
            }
    ...
    /// </summary>
    public static ApplicationXml Create(in Corvus.Json.JsonString nextMarker, in Corvus.Json.JsonString serviceEndpoint, in Corvus.Json.JsonString? marker = null, in Corvus.Json.JsonInteger? maxResults = null, in Corvus.Json.JsonString? prefix = null, in Azure.Files.Emulator.CompList.ServiceListSharesSegment.Content._200.ApplicationXml.AListedAzureStorageShareItemArray? shareItems = null)
    {
    ...
    /// <param name = "value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public ApplicationXml WithShareItems(in Azure.Files.Emulator.CompList.ServiceListSharesSegment.Content._200.ApplicationXml.AListedAzureStorageShareItemArray? value)
    {

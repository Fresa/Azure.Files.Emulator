...
"""),
            Comp = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileNameCompLeaseAcquire.CompQuery>(request, """
{
  "in": "query",
  "name": "comp",
  "description": "comp",
...
"""),
            XMsLeaseAction = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileNameCompLeaseAcquire.XMsLeaseActionHeader>(request, """
{
  "in": "header",
...
"""),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileNameCompLeaseAcquire.FileAcquireLease.TimeoutQuery>(request, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileNameCompLeaseAcquire.FileAcquireLease.XMsVersionHeader>(request, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileNameCompLeaseAcquire.FileAcquireLease.XMsFileRequestIntentHeader>(request, """
{
  "in": "header",

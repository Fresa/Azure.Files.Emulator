    ...
    public readonly partial struct CorsEntityArray
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("#/properties/Cors");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            /// <returns>The resulting validation context after validation.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal static ValidationContext ArrayValidationHandler(in CorsEntityArray value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
            {
                ValidationContext result = validationContext;
                ...
                int length = 0;
                using JsonArrayEnumerator<Azure.Files.Emulator.RestypeServiceCompProperties.ServiceSetProperties.RequestBodies.ApplicationXml.CorsEntityArray.CorsEntity> arrayEnumerator = value.EnumerateArray();

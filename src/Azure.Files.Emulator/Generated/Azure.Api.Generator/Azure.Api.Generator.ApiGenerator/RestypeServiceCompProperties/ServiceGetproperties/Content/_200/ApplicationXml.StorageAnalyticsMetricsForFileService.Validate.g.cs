                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    else if (property.NameEquals(JsonPropertyNames.RetentionPolicyUtf8, JsonPropertyNames.RetentionPolicy))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<RestypeServiceCompProperties.ServiceGetProperties.Content._200.ApplicationXml.StorageAnalyticsMetricsForFileService.TheRetentionPolicy>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }

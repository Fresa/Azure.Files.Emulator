                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty property in value.EnumerateObject())
                    {
                        if (property.NameEquals(JsonPropertyNames.DaysUtf8, JsonPropertyNames.Days))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<RestypeServiceCompProperties.ServiceGetProperties.ResponseBodies._200.ApplicationXml.StorageAnalyticsMetricsForFileService.TheRetentionPolicy.DaysEntity>().Validate(result.CreateChildContext(), level);

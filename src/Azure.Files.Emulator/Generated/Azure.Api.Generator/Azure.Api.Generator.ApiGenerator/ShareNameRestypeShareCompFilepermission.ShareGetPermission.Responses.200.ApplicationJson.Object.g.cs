...
namespace Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Responses._200;
/// <summary>
...
/// </para>
/// </remarks>
public readonly partial struct ApplicationJson : IJsonObject<Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Responses._200.ApplicationJson>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Responses._200.ApplicationJson.FormatEntity? Format
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.Format, out JsonAny result))
                {
                    ...
                    return result.As<Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Responses._200.ApplicationJson.FormatEntity>();
                }
            }
    ...
    /// <summary>
    /// Gets the <c>permission</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </summary>
    public static ApplicationJson Create(in Corvus.Json.JsonString permission, in Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Responses._200.ApplicationJson.FormatEntity? format = null)
    {
        var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
        builder.Add(JsonPropertyNames.Permission, permission.AsAny);
    ...
    public ApplicationJson WithFormat(in Azure.Files.Emulator.ShareNameRestypeShareCompFilepermission.ShareGetPermission.Responses._200.ApplicationJson.FormatEntity? value)
    {
        return value.HasValue ? this.SetProperty(JsonPropertyNames.Format, value.Value) : this.RemoveProperty(JsonPropertyNames.Format);
    }

    /// <summary>
    /// Sets the <c>permission</c> property.
    /// </summary>
    /// <param name = "value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    /// <remarks>
    ...
    /// </para>
    /// </remarks>
    public ApplicationJson WithPermission(in Corvus.Json.JsonString value)
    {
        return this.SetProperty(JsonPropertyNames.Permission, value);
    }

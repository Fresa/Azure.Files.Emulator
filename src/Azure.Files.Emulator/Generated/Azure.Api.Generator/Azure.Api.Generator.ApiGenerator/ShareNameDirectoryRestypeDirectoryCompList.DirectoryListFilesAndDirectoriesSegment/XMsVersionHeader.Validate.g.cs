...
public readonly partial struct XMsVersionHeader
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.XMsVersionHeader.json");
        }
    ...
    public static class EnumValues
    {
        ...
        /// as a <see cref = "ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.XMsVersionHeader"/>.
        /// </summary>
        ...
        /// </summary>
        public static ReadOnlySpan<byte> Value20251105Utf8 => CorvusValidation.EnumUtf8;
    }
    ...
    public static partial class CorvusValidation
    {
        ...
        /// </summary>
        public static readonly JsonString Enum = JsonString.ParseValue("\"2025-11-05\"");
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static ReadOnlySpan<byte> EnumUtf8 => "\"2025-11-05\""u8;
        ...
        /// <returns>The resulting validation context after validation.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static ValidationContext CompositionAnyOfValidationHandler(in XMsVersionHeader value, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ValidationContext result = validationContext;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            static ValidationContext ValidateEnum(in XMsVersionHeader value, in ValidationContext validationContext, ValidationLevel level)
            {
                ValidationContext result = validationContext;

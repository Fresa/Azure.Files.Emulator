...
"""),
            Restype = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompList.RestypeQuery>(request, """
{
  "in": "query",
  "name": "restype",
  "description": "restype",
...
"""),
            Comp = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompList.CompQuery>(request, """
{
  "in": "query",
  "name": "comp",
  "description": "comp",
...
""").AsOptional(),
            Maxresults = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.MaxresultsQuery>(request, """
{
  "in": "query",
  "name": "maxresults",
...
""").AsOptional(),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.TimeoutQuery>(request, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.XMsVersionHeader>(request, """
{
  "in": "header",
  "name": "x-ms-version",
...
"""),
            Include = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.IncludeQuery>(request, """
{
  "in": "query",
  "name": "include",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.XMsFileRequestIntentHeader>(request, """
{
  "in": "header",

...

{
    ...
    /// </summary>
    public static string SchemaLocation { get; } = "SharenameDirectoryRestypeDirectoryCompProperties.RestypeQuery.json";
    ...
    /// </summary>
    public static RestypeQuery DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in RestypeQuery left, in RestypeQuery right)
    {
    ...
    public static RestypeQuery FromJson(in JsonElement value)
    {
        return new(value);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static RestypeQuery IJsonValue<RestypeQuery>.FromBoolean<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>An instance of this type, initialized from the provided value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static RestypeQuery IJsonValue<RestypeQuery>.FromNumber<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>An instance of this type, initialized from the provided value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static RestypeQuery IJsonValue<RestypeQuery>.FromObject<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>An instance of this type, initialized from the provided value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static RestypeQuery IJsonValue<RestypeQuery>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    {
#if NET8_0_OR_GREATER
        return IJsonValue<RestypeQuery>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<RestypeQuery>(source.AsSpan());
#endif
    }
    ...
    public static RestypeQuery ParseValue(ReadOnlySpan<char> source)
    {
        ...
        return IJsonValue<RestypeQuery>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<RestypeQuery>(source);
#endif
    }
    ...
    {
#if NET8_0_OR_GREATER
        return IJsonValue<RestypeQuery>.ParseValue(ref source);
#else
        return JsonValueHelpers.ParseValue<RestypeQuery>(ref source);
#endif
    }
...
#else
        return this.As<RestypeQuery, TTarget>();
#endif
    }
    ...
    {
        return this.Equals(other.As<RestypeQuery>());
    }

...
/// </para>
/// </remarks>
public readonly partial struct ApplicationXml : IJsonObject<ShareNameRestypeShareCompFilepermission.ShareCreatePermission.RequestBodies.ApplicationXml>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public ShareNameRestypeShareCompFilepermission.ShareCreatePermission.RequestBodies.ApplicationXml.FormatEntity? Format
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.Format, out JsonAny result))
                {
                    ...
                    return result.As<ShareNameRestypeShareCompFilepermission.ShareCreatePermission.RequestBodies.ApplicationXml.FormatEntity>();
                }
            }
    ...
    /// </summary>
    public static ApplicationXml Create(in Corvus.Json.JsonString permission, in ShareNameRestypeShareCompFilepermission.ShareCreatePermission.RequestBodies.ApplicationXml.FormatEntity? format = null)
    {
    ...
    public ApplicationXml WithFormat(in ShareNameRestypeShareCompFilepermission.ShareCreatePermission.RequestBodies.ApplicationXml.FormatEntity? value)
    {

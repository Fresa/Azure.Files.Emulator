...
internal abstract partial class Response
{
    ...
    {
        public Accepted202(Corvus.Json.JsonAny applicationXml)
        {
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.FileBreakLease.Responses._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

        internal Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.FileBreakLease.Responses._Default.ApplicationXml? ApplicationXml { get; set; }

...
/// </para>
/// </remarks>
public readonly partial struct ApplicationXml : IJsonObject<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.Responses._200.ApplicationXml>
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the (optional) <c>HandleList</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray? HandleList
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                if (this.jsonElementBacking.TryGetProperty(JsonPropertyNames.HandleListUtf8, out JsonElement result))
                {
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.HandleList, out JsonAny result))
                {
                    ...
                    return result.As<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray>();
                }
            }
    ...
    /// </summary>
    public static ApplicationXml Create(in Corvus.Json.JsonString nextMarker, in Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray? handleList = null)
    {
        var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
        builder.Add(JsonPropertyNames.NextMarker, nextMarker.AsAny);
        if (handleList is not null)
        {
            builder.Add(JsonPropertyNames.HandleList, handleList.Value.AsAny);
        }
    ...
    /// <summary>
    /// Sets the (optional) <c>HandleList</c> property.
    /// </summary>
    /// <param name = "value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public ApplicationXml WithHandleList(in Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray? value)
    {
        return value.HasValue ? this.SetProperty(JsonPropertyNames.HandleList, value.Value) : this.RemoveProperty(JsonPropertyNames.HandleList);
    }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref = "HandleList"/>.
        /// </summary>
        public const string HandleList = "HandleList";
        /// <summary>
        ...
        /// Gets the JSON property name for <see cref = "HandleList"/>.
        /// </summary>
        public static ReadOnlySpan<byte> HandleListUtf8 => "HandleList"u8;
        /// <summary>
        /// Gets the JSON property name for <see cref = "NextMarker"/>.
        /// </summary>

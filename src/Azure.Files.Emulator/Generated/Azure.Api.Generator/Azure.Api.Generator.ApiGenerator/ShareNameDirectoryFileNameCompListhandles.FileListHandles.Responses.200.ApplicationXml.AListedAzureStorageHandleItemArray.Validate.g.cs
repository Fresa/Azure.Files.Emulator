    ...
    public readonly partial struct AListedAzureStorageHandleItemArray
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("#/properties/HandleList");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            /// <returns>The resulting validation context after validation.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal static ValidationContext ArrayValidationHandler(in AListedAzureStorageHandleItemArray value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
            {
                ValidationContext result = validationContext;
                ...
                int length = 0;
                using JsonArrayEnumerator<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem> arrayEnumerator = value.EnumerateArray();

...
public readonly partial struct ApplicationXml
{
    ...
    public readonly partial struct AbstractForEntriesThatCanBeListedFromDirectory
    {
        ...
        public readonly partial struct AListedFileItemArray
        {
            ...
            /// </para>
            /// </remarks>
            public readonly partial struct AListedFileItem : IJsonObject<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Responses._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem>
            {
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Responses._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.NameEntity Name
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        ...
                        if ((this.backing & Backing.Object) != 0)
                        {
                            ...
                            {
                                return result.As<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Responses._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.NameEntity>();
                            }
                        }
                ...
                /// </para>
                /// </remarks>
                public Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Responses._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.FileProperties Properties
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        ...
                        if ((this.backing & Backing.Object) != 0)
                        {
                            ...
                            {
                                return result.As<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Responses._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.FileProperties>();
                            }
                        }
                ...
                /// </summary>
                public static AListedFileItem Create(in Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Responses._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.NameEntity name, in Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Responses._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.FileProperties properties, in Corvus.Json.JsonString? attributes = null, in Corvus.Json.JsonString? fileId = null, in Corvus.Json.JsonString? permissionKey = null)
                {
                ...
                /// <param name = "value">The new property value</param>
                /// <returns>The instance with the property set.</returns>
                public AListedFileItem WithName(in Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Responses._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.NameEntity value)
                {
                ...
                /// </para>
                /// </remarks>
                public AListedFileItem WithProperties(in Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Responses._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.FileProperties value)
                {

...
namespace ShareNameRestypeShareCompFilepermission.ShareGetPermission.ResponseBodies._200;
/// <summary>
...
public readonly partial struct ApplicationJson
    : IJsonObject<ShareNameRestypeShareCompFilepermission.ShareGetPermission.ResponseBodies._200.ApplicationJson>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public ShareNameRestypeShareCompFilepermission.ShareGetPermission.ResponseBodies._200.ApplicationJson.FormatEntity? Format
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.Format, out JsonAny result))
                {
                    ...
                    return result.As<ShareNameRestypeShareCompFilepermission.ShareGetPermission.ResponseBodies._200.ApplicationJson.FormatEntity>();
                }
            }
    ...
    /// </summary>
    public static ApplicationJson Create(in Corvus.Json.JsonString permission, in ShareNameRestypeShareCompFilepermission.ShareGetPermission.ResponseBodies._200.ApplicationJson.FormatEntity? format = null)
    {
    ...
    public ApplicationJson WithFormat(in ShareNameRestypeShareCompFilepermission.ShareGetPermission.ResponseBodies._200.ApplicationJson.FormatEntity? value)
    {

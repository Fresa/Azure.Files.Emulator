    ...
    public readonly partial struct ApplicationXmlStorageAnalyticsMetricsForFileService
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("#/properties/MinuteMetrics");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ObjectValidationHandler(in ApplicationXmlStorageAnalyticsMetricsForFileService value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ValidationContext result = validationContext;
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    else if (property.NameEquals(JsonPropertyNames.RetentionPolicyUtf8, JsonPropertyNames.RetentionPolicy))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Azure.Files.Emulator.RestypeServiceCompProperties.ServiceSetProperties.RequestBodies.ApplicationXml.ApplicationXmlStorageAnalyticsMetricsForFileService.TheRetentionPolicy>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }

                    ...
                    internal static ValidationContext ObjectValidationHandler(in AListedFileItem value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        foreach (JsonObjectProperty property in value.EnumerateObject())
                        {
                            ...
                            else if (property.NameEquals(JsonPropertyNames.PropertiesUtf8, JsonPropertyNames.Properties))
                            {
                                ...
                                ValidationContext propertyResult = property.Value.As<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Responses._200.ApplicationXml.AbstractForEntriesThatCanBeListedFromDirectory.AListedFileItemArray.AListedFileItem.FileProperties>().Validate(result.CreateChildContext(), level);
                                if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                                {
                                    return propertyResult;
                                }

...
/// </para>
/// </remarks>
public readonly partial struct ApplicationXml : IJsonObject<ShareNameDirectoryCompListhandles.DirectoryListHandles.Content._200.ApplicationXml>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public ShareNameDirectoryCompListhandles.DirectoryListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray? HandleList
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.HandleList, out JsonAny result))
                {
                    ...
                    return result.As<ShareNameDirectoryCompListhandles.DirectoryListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray>();
                }
            }
    ...
    /// </summary>
    public static ApplicationXml Create(in Corvus.Json.JsonString nextMarker, in ShareNameDirectoryCompListhandles.DirectoryListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray? handleList = null)
    {
    ...
    public ApplicationXml WithHandleList(in ShareNameDirectoryCompListhandles.DirectoryListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray? value)
    {

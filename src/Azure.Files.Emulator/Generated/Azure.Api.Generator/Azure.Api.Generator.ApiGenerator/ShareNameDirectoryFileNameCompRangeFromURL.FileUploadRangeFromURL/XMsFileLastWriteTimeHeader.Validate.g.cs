...
public readonly partial struct XMsFileLastWriteTimeHeader
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("ShareNameDirectoryFileNameCompRangeFromURL.FileUploadRangeFromURL.XMsFileLastWriteTimeHeader.json");
        }
    ...
    public static class EnumValues
    {
        /// <summary>
        /// Gets the string 'Now'
        /// as a <see cref = "ShareNameDirectoryFileNameCompRangeFromURL.FileUploadRangeFromURL.XMsFileLastWriteTimeHeader"/>.
        /// </summary>
        ...
        /// </summary>
        public static ReadOnlySpan<byte> NowUtf8 => CorvusValidation.Enum1Utf8;
        /// <summary>
        ...
        /// as a UTF8 byte array.
        /// </summary>
        public static ReadOnlySpan<byte> PreserveUtf8 => CorvusValidation.Enum2Utf8;
    }
    ...
    public static partial class CorvusValidation
    {
        ...
        /// </summary>
        public static readonly JsonString Enum1 = JsonString.ParseValue("\"Now\"");
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly JsonString Enum2 = JsonString.ParseValue("\"Preserve\"");
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static ReadOnlySpan<byte> Enum1Utf8 => "\"Now\""u8;
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static ReadOnlySpan<byte> Enum2Utf8 => "\"Preserve\""u8;
        ...
        /// <returns>The resulting validation context after validation.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static ValidationContext CompositionAnyOfValidationHandler(in XMsFileLastWriteTimeHeader value, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ValidationContext result = validationContext;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            static ValidationContext ValidateEnum(in XMsFileLastWriteTimeHeader value, in ValidationContext validationContext, ValidationLevel level)
            {
                ValidationContext result = validationContext;

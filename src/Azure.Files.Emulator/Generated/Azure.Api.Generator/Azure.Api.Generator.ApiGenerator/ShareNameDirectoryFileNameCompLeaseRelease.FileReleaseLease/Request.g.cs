...
internal partial class Request
{
    ...
    internal required ShareNameDirectoryFileNameCompLeaseRelease.CompQuery Comp { get; init; }
    internal required ShareNameDirectoryFileNameCompLeaseRelease.XMsLeaseActionHeader XMsLeaseAction { get; init; }
    internal ShareNameDirectoryFileNameCompLeaseRelease.FileReleaseLease.TimeoutQuery? Timeout { get; init; }
    internal required Corvus.Json.JsonString XMsLeaseId { get; init; }
    internal required ShareNameDirectoryFileNameCompLeaseRelease.FileReleaseLease.XMsVersionHeader XMsVersion { get; init; }
    internal Corvus.Json.JsonString? XMsClientRequestId { get; init; }
    internal Corvus.Json.JsonBoolean? XMsAllowTrailingDot { get; init; }
    internal ShareNameDirectoryFileNameCompLeaseRelease.FileReleaseLease.XMsFileRequestIntentHeader? XMsFileRequestIntent { get; init; }
...
"""),
            Comp = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileNameCompLeaseRelease.CompQuery>(request, """
{
  "in": "query",
  "name": "comp",
  "description": "comp",
...
"""),
            XMsLeaseAction = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileNameCompLeaseRelease.XMsLeaseActionHeader>(request, """
{
  "in": "header",
...
"""),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileNameCompLeaseRelease.FileReleaseLease.TimeoutQuery>(request, """
{
  "in": "query",
  "name": "timeout",
...
"""),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileNameCompLeaseRelease.FileReleaseLease.XMsVersionHeader>(request, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<ShareNameDirectoryFileNameCompLeaseRelease.FileReleaseLease.XMsFileRequestIntentHeader>(request, """
{
  "in": "header",

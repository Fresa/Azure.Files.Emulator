...
public readonly partial struct RestypeQuery 
    ...
    : IJsonString<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompProperties.RestypeQuery>,
      ISpanFormattable
#else
: IJsonString<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompProperties.RestypeQuery>
#endif
{
    ...
    public RestypeQuery(in ReadOnlySpan<char> value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public RestypeQuery(in ReadOnlySpan<byte> value)
    {
        this.backing = Backing.String;
        this.jsonElementBacking = default;
#if NET8_0_OR_GREATER
    ...
    public static implicit operator RestypeQuery(string value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator RestypeQuery(JsonString value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator JsonString(RestypeQuery value)
    {
    ...
    public static explicit operator string (RestypeQuery value)
    {
    ...
    /// <summary>
    /// Concatenate 2 JSON values, producing an instance of the string type RestypeQuery.
    /// </summary>
    ...
    public static RestypeQuery Concatenate<T1, T2>(Span<byte> buffer, in T1 value1, in T2 value2)
    ...
    /// <summary>
    /// Concatenate 3 JSON values, producing an instance of the string type RestypeQuery.
    /// </summary>
    /// <typeparam name = "T1">The type of the 1st value.</typeparam>
    /// <typeparam name = "T2">The type of the 2nd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static RestypeQuery Concatenate<T1, T2, T3>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3)
    ...
    /// <summary>
    /// Concatenate 4 JSON values, producing an instance of the string type RestypeQuery.
    /// </summary>
    /// <typeparam name = "T1">The type of the 1st value.</typeparam>
    /// <typeparam name = "T2">The type of the 2nd value.</typeparam>
    /// <typeparam name = "T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static RestypeQuery Concatenate<T1, T2, T3, T4>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4)
    ...
    /// <summary>
    /// Concatenate 5 JSON values, producing an instance of the string type RestypeQuery.
    /// </summary>
    /// <typeparam name = "T1">The type of the 1st value.</typeparam>
    /// <typeparam name = "T2">The type of the 2nd value.</typeparam>
    /// <typeparam name = "T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static RestypeQuery Concatenate<T1, T2, T3, T4, T5>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5)
    ...
    /// <summary>
    /// Concatenate 6 JSON values, producing an instance of the string type RestypeQuery.
    /// </summary>
    /// <typeparam name = "T1">The type of the 1st value.</typeparam>
    /// <typeparam name = "T2">The type of the 2nd value.</typeparam>
    /// <typeparam name = "T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static RestypeQuery Concatenate<T1, T2, T3, T4, T5, T6>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6)
    ...
    /// <summary>
    /// Concatenate 7 JSON values, producing an instance of the string type RestypeQuery.
    /// </summary>
    /// <typeparam name = "T1">The type of the 1st value.</typeparam>
    /// <typeparam name = "T2">The type of the 2nd value.</typeparam>
    /// <typeparam name = "T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static RestypeQuery Concatenate<T1, T2, T3, T4, T5, T6, T7>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6, in T7 value7)
    ...
    /// <summary>
    /// Concatenate 8 JSON values, producing an instance of the string type RestypeQuery.
    /// </summary>
    /// <typeparam name = "T1">The type of the 1st value.</typeparam>
    /// <typeparam name = "T2">The type of the 2nd value.</typeparam>
    /// <typeparam name = "T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static RestypeQuery Concatenate<T1, T2, T3, T4, T5, T6, T7, T8>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6, in T7 value7, in T8 value8)

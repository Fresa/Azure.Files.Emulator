...
internal abstract partial class Response
{
    ...
    {
        public OK200(Azure.Files.Emulator.ShareNameRestypeShareCompStats.ShareGetStatistics.Content._200.ApplicationXml applicationXml)
        {
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameRestypeShareCompStats.ShareGetStatistics.Content._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

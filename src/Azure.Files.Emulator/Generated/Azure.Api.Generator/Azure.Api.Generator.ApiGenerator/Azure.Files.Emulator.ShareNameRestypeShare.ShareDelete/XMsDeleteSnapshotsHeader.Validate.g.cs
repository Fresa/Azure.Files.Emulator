...
public readonly partial struct XMsDeleteSnapshotsHeader
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("XMsDeleteSnapshotsHeader.json");
        }
    ...
    public static class EnumValues
    {
        ...
        /// as a <see cref = "Azure.Files.Emulator.ShareNameRestypeShare.ShareDelete.XMsDeleteSnapshotsHeader"/>.
        /// </summary>
        ...
        /// </summary>
        public static ReadOnlySpan<byte> IncludeUtf8 => CorvusValidation.Enum1Utf8;
        /// <summary>
        ...
        /// as a UTF8 byte array.
        /// </summary>
        public static ReadOnlySpan<byte> IncludeLeasedUtf8 => CorvusValidation.Enum2Utf8;
    }
    ...
    public static partial class CorvusValidation
    {
        ...
        /// </summary>
        public static readonly JsonString Enum1 = JsonString.ParseValue("\"include\"");
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly JsonString Enum2 = JsonString.ParseValue("\"include-leased\"");
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static ReadOnlySpan<byte> Enum1Utf8 => "\"include\""u8;
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static ReadOnlySpan<byte> Enum2Utf8 => "\"include-leased\""u8;
        ...
        /// <returns>The resulting validation context after validation.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static ValidationContext CompositionAnyOfValidationHandler(in XMsDeleteSnapshotsHeader value, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ValidationContext result = validationContext;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            static ValidationContext ValidateEnum(in XMsDeleteSnapshotsHeader value, in ValidationContext validationContext, ValidationLevel level)
            {
                ValidationContext result = validationContext;

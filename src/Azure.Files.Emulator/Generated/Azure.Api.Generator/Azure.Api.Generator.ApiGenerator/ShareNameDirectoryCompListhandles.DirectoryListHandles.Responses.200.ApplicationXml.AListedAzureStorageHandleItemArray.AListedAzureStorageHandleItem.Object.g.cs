...
public readonly partial struct ApplicationXml
{
    ...
    public readonly partial struct AListedAzureStorageHandleItemArray
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct AListedAzureStorageHandleItem : IJsonObject<Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem>
        {
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.AccessRightsOfTheAccessPolicyArray? AccessRightList
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        if (this.objectBacking.TryGetValue(JsonPropertyNames.AccessRightList, out JsonAny result))
                        {
                            ...
                            return result.As<Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.AccessRightsOfTheAccessPolicyArray>();
                        }
                    }
            ...
            /// </para>
            /// </remarks>
            public Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.PathEntity Path
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.PathEntity>();
                        }
                    }
            ...
            public AListedAzureStorageHandleItem WithAccessRightList(in Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.AccessRightsOfTheAccessPolicyArray? value)
            {
            ...
            /// <param name = "value">The new property value</param>
            /// <returns>The instance with the property set.</returns>
            public AListedAzureStorageHandleItem WithPath(in Azure.Files.Emulator.ShareNameDirectoryCompListhandles.DirectoryListHandles.Responses._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.PathEntity value)
            {

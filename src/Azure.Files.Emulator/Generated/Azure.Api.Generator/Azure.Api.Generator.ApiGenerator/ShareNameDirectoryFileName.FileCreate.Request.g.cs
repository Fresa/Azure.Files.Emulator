...
internal partial class Request
{
    ...
    internal Azure.Files.Emulator.ShareNameDirectoryFileName.FileCreate.TimeoutQuery? Timeout { get; init; }
    internal required Azure.Files.Emulator.ShareNameDirectoryFileName.FileCreate.XMsVersionHeader XMsVersion { get; init; }
    ...
    internal Azure.Files.Emulator.ShareNameDirectoryFileName.FileCreate.XMsFileRequestIntentHeader? XMsFileRequestIntent { get; init; }
...
""").AsOptional(),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileName.FileCreate.TimeoutQuery>(httpRequest, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileName.FileCreate.XMsVersionHeader>(httpRequest, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileName.FileCreate.XMsFileRequestIntentHeader>(httpRequest, """
{
  "in": "header",

...
internal abstract partial class Response
{
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameDirectoryRestypeDirectory.DirectoryDelete.Responses._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

        internal Azure.Files.Emulator.ShareNameDirectoryRestypeDirectory.DirectoryDelete.Responses._Default.ApplicationXml? ApplicationXml { get; set; }

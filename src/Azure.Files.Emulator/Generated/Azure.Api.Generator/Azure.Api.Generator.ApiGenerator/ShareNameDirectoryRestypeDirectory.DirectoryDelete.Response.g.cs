...
internal abstract partial class Response
{
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameDirectoryRestypeDirectory.DirectoryDelete.Content._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

        internal Azure.Files.Emulator.ShareNameDirectoryRestypeDirectory.DirectoryDelete.Content._Default.ApplicationXml? ApplicationXml { get; set; }

...
internal abstract partial class Response
{
    ...
    {
        public OK200(Azure.Files.Emulator.ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.Content._200.ApplicationXml applicationXml)
        {
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameRestypeShareCompAcl.ShareGetAccessPolicy.Content._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

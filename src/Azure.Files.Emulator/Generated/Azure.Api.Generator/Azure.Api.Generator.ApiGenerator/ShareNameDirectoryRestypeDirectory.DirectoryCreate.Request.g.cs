...
""").AsOptional(),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectory.DirectoryCreate.TimeoutQuery>(httpRequest, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectory.DirectoryCreate.XMsVersionHeader>(httpRequest, """
{
  "in": "header",
  "name": "x-ms-version",
...
"""),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryRestypeDirectory.DirectoryCreate.XMsFileRequestIntentHeader>(httpRequest, """
{
  "in": "header",

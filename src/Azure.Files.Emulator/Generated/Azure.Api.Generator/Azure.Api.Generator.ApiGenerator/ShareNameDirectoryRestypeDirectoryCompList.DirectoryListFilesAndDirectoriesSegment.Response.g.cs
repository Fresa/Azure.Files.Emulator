...
internal abstract partial class Response
{
    ...
    {
        public OK200(Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Content._200.ApplicationXml applicationXml)
        {
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameDirectoryRestypeDirectoryCompList.DirectoryListFilesAndDirectoriesSegment.Content._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

...
internal partial class Request
{
    ...
    internal Azure.Files.Emulator.ShareNameRestypeShare.ShareCreate.TimeoutQuery? Timeout { get; init; }
    internal required Azure.Files.Emulator.ShareNameRestypeShare.ShareCreate.XMsVersionHeader XMsVersion { get; init; }
    internal Corvus.Json.JsonString? XMsLeaseId { get; init; }
    internal Azure.Files.Emulator.ShareNameRestypeShare.ShareCreate.XMsFileRequestIntentHeader? XMsFileRequestIntent { get; init; }

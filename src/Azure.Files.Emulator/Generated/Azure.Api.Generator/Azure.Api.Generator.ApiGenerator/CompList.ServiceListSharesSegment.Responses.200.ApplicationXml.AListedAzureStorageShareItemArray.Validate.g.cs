    ...
    public readonly partial struct AListedAzureStorageShareItemArray
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("#/properties/ShareItems");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            /// <returns>The resulting validation context after validation.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal static ValidationContext ArrayValidationHandler(in AListedAzureStorageShareItemArray value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
            {
                ValidationContext result = validationContext;
                ...
                int length = 0;
                using JsonArrayEnumerator<Azure.Files.Emulator.CompList.ServiceListSharesSegment.Responses._200.ApplicationXml.AListedAzureStorageShareItemArray.AListedAzureStorageShareItem> arrayEnumerator = value.EnumerateArray();

                ...
                internal static ValidationContext ObjectValidationHandler(in AListedAzureStorageHandleItem value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty property in value.EnumerateObject())
                    {
                        if (property.NameEquals(JsonPropertyNames.AccessRightListUtf8, JsonPropertyNames.AccessRightList))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.AccessRightsOfTheAccessPolicyArray>().Validate(result.CreateChildContext(), level);
                        ...
                        else if (property.NameEquals(JsonPropertyNames.PathUtf8, JsonPropertyNames.Path))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<Azure.Files.Emulator.ShareNameDirectoryFileNameCompListhandles.FileListHandles.Content._200.ApplicationXml.AListedAzureStorageHandleItemArray.AListedAzureStorageHandleItem.PathEntity>().Validate(result.CreateChildContext(), level);
                            if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                            {
                                return propertyResult;
                            }

...
internal abstract partial class Response
{
    ...
    {
        public Default(Azure.Files.Emulator.ShareNameDirectoryRestypeDirectory.DirectoryGetProperties.Responses._Default.ApplicationXml applicationXml)
        {
            ApplicationXml = applicationXml;
        }

        internal Azure.Files.Emulator.ShareNameDirectoryRestypeDirectory.DirectoryGetProperties.Responses._Default.ApplicationXml? ApplicationXml { get; set; }

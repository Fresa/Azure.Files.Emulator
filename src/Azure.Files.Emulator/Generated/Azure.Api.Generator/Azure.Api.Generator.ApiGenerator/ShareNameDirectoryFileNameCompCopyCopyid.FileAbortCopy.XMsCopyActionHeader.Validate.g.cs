...
public readonly partial struct XMsCopyActionHeader
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("XMsCopyActionHeader.json");
        }
    ...
    public static class EnumValues
    {
        ...
        /// as a <see cref = "Azure.Files.Emulator.ShareNameDirectoryFileNameCompCopyCopyid.FileAbortCopy.XMsCopyActionHeader"/>.
        /// </summary>
        ...
        /// </summary>
        public static ReadOnlySpan<byte> AbortUtf8 => CorvusValidation.EnumUtf8;
    }
    ...
    public static partial class CorvusValidation
    {
        ...
        /// </summary>
        public static readonly JsonString Enum = JsonString.ParseValue("\"abort\"");
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static ReadOnlySpan<byte> EnumUtf8 => "\"abort\""u8;
        ...
        /// <returns>The resulting validation context after validation.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static ValidationContext CompositionAnyOfValidationHandler(in XMsCopyActionHeader value, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ValidationContext result = validationContext;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            static ValidationContext ValidateEnum(in XMsCopyActionHeader value, in ValidationContext validationContext, ValidationLevel level)
            {
                ValidationContext result = validationContext;

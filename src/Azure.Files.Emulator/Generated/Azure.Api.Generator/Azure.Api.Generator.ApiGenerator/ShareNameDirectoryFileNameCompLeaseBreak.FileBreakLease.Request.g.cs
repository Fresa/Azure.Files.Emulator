...
internal partial class Request
{
    ...
    internal required Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.CompQuery Comp { get; init; }
    internal required Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.XMsLeaseActionHeader XMsLeaseAction { get; init; }
    internal Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.FileBreakLease.TimeoutQuery? Timeout { get; init; }
    internal Corvus.Json.JsonString? XMsLeaseId { get; init; }
    internal required Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.FileBreakLease.XMsVersionHeader XMsVersion { get; init; }
    internal Corvus.Json.JsonString? XMsClientRequestId { get; init; }
    internal Corvus.Json.JsonBoolean? XMsAllowTrailingDot { get; init; }
    internal Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.FileBreakLease.XMsFileRequestIntentHeader? XMsFileRequestIntent { get; init; }
...
"""),
            Comp = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.CompQuery>(httpRequest, """
{
  "in": "query",
  "name": "comp",
  "description": "comp",
...
"""),
            XMsLeaseAction = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.XMsLeaseActionHeader>(httpRequest, """
{
  "in": "header",
...
"""),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.FileBreakLease.TimeoutQuery>(httpRequest, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.FileBreakLease.XMsVersionHeader>(httpRequest, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameCompLeaseBreak.FileBreakLease.XMsFileRequestIntentHeader>(httpRequest, """
{
  "in": "header",

...
public readonly partial struct ApplicationXml
    : IJsonObject<CompList.ServiceListSharesSegment.ResponseBodies._200.ApplicationXml>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public CompList.ServiceListSharesSegment.ResponseBodies._200.ApplicationXml.AListedAzureStorageShareItemArray? ShareItems
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.ShareItems, out JsonAny result))
                {
                    ...
                    return result.As<CompList.ServiceListSharesSegment.ResponseBodies._200.ApplicationXml.AListedAzureStorageShareItemArray>();
                }
            }
    ...
    public static ApplicationXml Create(
        ...
        in CompList.ServiceListSharesSegment.ResponseBodies._200.ApplicationXml.AListedAzureStorageShareItemArray? shareItems = null)
    {
    ...
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public ApplicationXml WithShareItems(in CompList.ServiceListSharesSegment.ResponseBodies._200.ApplicationXml.AListedAzureStorageShareItemArray? value)
    {

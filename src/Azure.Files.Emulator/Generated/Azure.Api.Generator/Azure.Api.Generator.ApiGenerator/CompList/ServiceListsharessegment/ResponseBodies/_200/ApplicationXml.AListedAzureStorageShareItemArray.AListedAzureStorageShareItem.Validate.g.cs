        ...
        public readonly partial struct AListedAzureStorageShareItem
        {
            ...
            public static partial class CorvusValidation
            {
                ...
                internal static ValidationContext ObjectValidationHandler(
                    in AListedAzureStorageShareItem value,
                    JsonValueKind valueKind,
                    in ValidationContext validationContext,
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty property in value.EnumerateObject())
                    {
                        ...
                        else if (property.NameEquals(JsonPropertyNames.MetadataUtf8, JsonPropertyNames.Metadata))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<CompList.ServiceListSharesSegment.ResponseBodies._200.ApplicationXml.AListedAzureStorageShareItemArray.AListedAzureStorageShareItem.MetadataEntity>().Validate(result.CreateChildContext(), level);
                            if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                            {
                                return propertyResult;
                            }
                        ...
                        else if (property.NameEquals(JsonPropertyNames.PropertiesUtf8, JsonPropertyNames.Properties))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<CompList.ServiceListSharesSegment.ResponseBodies._200.ApplicationXml.AListedAzureStorageShareItemArray.AListedAzureStorageShareItem.PropertiesOfAShare>().Validate(result.CreateChildContext(), level);
                            if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                            {
                                return propertyResult;
                            }

...
internal partial class Request
{
    ...
    internal required Azure.Files.Emulator.ShareNameDirectoryFileNameRestypeSymboliclink.RestypeQuery Restype { get; init; }
    internal Azure.Files.Emulator.ShareNameDirectoryFileNameRestypeSymboliclink.FileCreateSymbolicLink.TimeoutQuery? Timeout { get; init; }
    internal Corvus.Json.JsonString? Sharesnapshot { get; init; }
    internal required Azure.Files.Emulator.ShareNameDirectoryFileNameRestypeSymboliclink.FileCreateSymbolicLink.XMsVersionHeader XMsVersion { get; init; }
    internal Corvus.Json.JsonString? XMsClientRequestId { get; init; }
    internal Azure.Files.Emulator.ShareNameDirectoryFileNameRestypeSymboliclink.FileCreateSymbolicLink.XMsFileRequestIntentHeader? XMsFileRequestIntent { get; init; }
...
"""),
            Restype = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameRestypeSymboliclink.RestypeQuery>(httpRequest, """
{
  "in": "query",
  "name": "restype",
  "description": "restype",
...
"""),
            Timeout = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameRestypeSymboliclink.FileCreateSymbolicLink.TimeoutQuery>(httpRequest, """
{
  "in": "query",
  "name": "timeout",
...
""").AsOptional(),
            XMsVersion = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameRestypeSymboliclink.FileCreateSymbolicLink.XMsVersionHeader>(httpRequest, """
{
  "in": "header",
  "name": "x-ms-version",
...
""").AsOptional(),
            XMsFileRequestIntent = Azure.Files.Emulator.HttpRequestExtensions.Bind<Azure.Files.Emulator.ShareNameDirectoryFileNameRestypeSymboliclink.FileCreateSymbolicLink.XMsFileRequestIntentHeader>(httpRequest, """
{
  "in": "header",
...
""").AsOptional(),
            XMsLinkText = Azure.Files.Emulator.HttpRequestExtensions.Bind<Corvus.Json.JsonString>(httpRequest, """
{
  "in": "header",
  "name": "x-ms-link-text",
